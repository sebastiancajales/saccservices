      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active"><a href="http://127.0.0.1:8000/" class="nav-link">Inicio</a></li>
            <li class="nav-item"><a href="http://127.0.0.1:8000/servicios" class="nav-link">Servicios</a></li>
            <li class="nav-item"><a href="http://127.0.0.1:8000/casos" class="nav-link">Casos</a></li>
            <li class="nav-item"><a href="http://127.0.0.1:8000/blog" class="nav-link">Blog</a></li>
            <li class="nav-item "><a href="http://127.0.0.1:8000/nosotros" class="nav-link">Nosotros</a></li>
            <li class="nav-item"><a href="http://127.0.0.1:8000/contacto" class="nav-link">Contacto</a></li>
          </ul>
        </div>
      </div>
    </nav>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center ftco-vh-100">
          <div class="col-md-8 text-center">
            <h1 class="ftco-heading mb-4" data-aos="fade-up" data-aos-delay="500">The Greatest Law Firm You Can Trust</h1>
            ...
            <p data-aos="fade-up"  data-aos-delay="700"><a href="https://free-template.co/" target="_blank" class="btn btn-outline-white px-4 py-3" data-toggle="modal" data-target="#reservationModal">Read more</a></p>
          </div>
        </div>
      </div>
    </section>
  ...
  <footer class="ftco-footer ftco-bg-dark ftco-section">
    <div class="container">
      <div class="row mb-5">
        ...
        <div class="col-md">
           <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2">Communidad</h2>
            <ul class="list-unstyled">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos Los Derechos Reservados | Theme en Laravel Por : <a href="https://www.saccservices.cl" target="_blank" class="text-primary">SaccServices</a>
